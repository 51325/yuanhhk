...
class Cms extends TagLib
{
    ...
    protected $tags = [
        ...
        'parentchannel'     => ['attr' => 'name', 'close' => 0],
        ...
        'channellist' => ['attr' => 'id,row,limit,empty,key,mod,cache,orderby,orderway,imgwidth,imgheight,condition,model,type,typeid,field,status', 'close' => 1],
    ...
    public function tagParentchannel($tag)
    {
        return '{$__PARENTCHANNEL__.' . $tag['name'] . '}';
    }
