...
class Archives extends Model
{
    ...
    {
        $value = $value ? $value : $data['activestarttime'];
        return is_numeric($value) ? date("Y-m-d H:i:s", $value) : $value;
    }
    ...
    public function getActiveendtimeTextAttr($value, $data)
    {
        $value = $value ? $value : $data['activeendtime'];
        return is_numeric($value) ? date("Y-m-d H:i:s", $value) : $value;
    }

    protected function setActiveendtimeAttr($value)
    {
        return $value && !is_numeric($value) ? strtotime($value) : ($value ? $value : null);
    }
